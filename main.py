...
keyboard = InlineKeyboardMarkup(
    [
        [
            ...
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3JxINYwNGZl"),
        ],
    ]
)
...
Busy = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/Naini_khe"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3k-1zcJxINZl"),
        ],
    ]
)
...
async def help_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        "<pre><code>Contact to ミ★ W A C K Y 🏴‍☠️ ★彡 for buy membership.</code></pre>"
    ))

@bot.on_message(filters.command(["help"]))
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        "<pre><code> 🎉Congrats! You are using ミ★ W A C K Y 🏴‍☠️ ★彡:</code></pre>\n┣\n"
...
async def txt_handler(bot: Client, m: Message):
    ...
    await m.reply_text(f"`✨𝙱𝚊𝚝𝚌𝚑 𝚂𝚞𝚖𝚖𝚊𝚛𝚢✨\n"
                       ...
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"✅𝚂𝚝𝚊𝚝𝚞𝚜 » 𝙲𝚘𝚖𝚙𝚕𝚎𝚝𝚎𝚍`")
    await m.reply_text("<pre><code>Downloaded By ⌈✨ミ★ W A C K Y 🏴‍☠️ ★彡✨⌋</code></pre>")
